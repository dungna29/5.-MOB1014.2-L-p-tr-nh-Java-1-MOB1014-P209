...
public class B1_LyThuyet_OOP {
    ...
    public static void main(String[] args) {
        ...
        //Phần 1: Khai báo và khởi tạo một đối tượng cần phải biết tên đối tượng
        SinhVien sv1;//Khai báo
        sv1 = new SinhVien();//Khởi tạo 1 đối tượng
        
        SinhVien sv2 = new SinhVien();//Khởi tạo sinh viên số 2
        
        SinhVien sv3 = new SinhVien("PH00555", "UDPM", 2000, "123@gmail");
        
        //Phần 2: Gán giá trị cho đối tượng có thể sử Setter và Contructor có tham số
        sv1.setMsv("PH111");
        sv1.setNganhHoc("WEB");
     
        
        //Phần 3: In các thuộc tính của đố tượng thông qua Getter và phương thức
        
        //Dùng phương thức để in
        sv3.inRaManHinh();
        sv2.inRaManHinh();
        //Dùng getter
